...
- [jev-harness](https://github.com/AntonioCoppe/jev-harness) - Decision harness for TypeSafe Jev: confidence gates, shadow mode, recipes, and action-level evals for structured Choice/Score/Noul decisions.
